      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-4">
            ...
            <button className="p-5 border border-zinc-200 hover:border-zinc-900 transition-colors">
          ...
          <div className="mt-12 space-y-6 pt-12 border-t">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500">Every item is verified by our luxury specialists.</p>
              </div>
            </div>
          </div>
        </div>
