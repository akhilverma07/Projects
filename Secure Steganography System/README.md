...
- **Admin Dashboard**: System overview, security events chart, recent activity
- **User Dashboard**: Personal file stats, security breakdown
...
2. Create your first user account (username ≥ 3 chars, password ≥ 8 chars)
3. Log in at `http://127.0.0.1:8000/login`
4. Admin users can be promoted from the **User Management** page

> **Note:** The first registered user has the `user` role. To create an admin account, an existing admin must do it via the Admin → User Management page.
